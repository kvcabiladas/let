...
reader = pypdf.PdfReader('/Users/kvcabiladas/.gemini/antigravity-ide/brain/3aa1c9e2-45b2-4ae3-bb31-b24814b6c7eb/.user_uploaded/media_1789427361563.pdf')

print("Total pages:", len(reader.pages))

pages_data = []

for p_idx in range(1, len(reader.pages) - 1): # Skip cover (p0) and last page (68)
...
for p_num, lines in pages_data[:3]:
    print(f"=== PAGE {p_num} ===")
    for l in lines:
        print("  ", l)
